        ...
        http
                .cors(corsCustomizer -> corsCustomizer.configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:8080", "http://localhost:8081", SPRING_SERVER_URL, "http://localhost:5173", " http://localhost:5173/", "https://dotoread.vercel.app", "https://dotoread.vercel.app/"));
...
//                .addFilterBefore(new JWTFilter(jwtUtil), UsernamePasswordAuthenticationFilter.class);
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        ...
                        .requestMatchers("/swagger-ui/**","/error","/swagger-resources/**","/v3/api-docs/**","/health", "test", "login-check").permitAll()
